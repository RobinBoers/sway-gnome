...
license=("MIT")
depends=(sway swaylock-effects swayidle swaybg kanshi mako gnome-session xdg-desktop-portal polkit-gnome gnome-keyring gnome-settings-daemon clipman brightnessctl playerctl redshift gnome-control-center wob)
makedepends=(meson)
provides=("$_pkgname")
